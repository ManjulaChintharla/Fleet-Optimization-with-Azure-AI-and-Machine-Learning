...
az cognitiveservices account deployment create -g $RESOURCE_GROUP -n $AZURE_OPENAI_NAME  --deployment-name completions  --model-name gpt-35-turbo --model-version "0125" --model-format OpenAI --sku-capacity 1 --sku-name "Standard"
